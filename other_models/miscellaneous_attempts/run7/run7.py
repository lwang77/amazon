...
conv1 = Conv2D(48, (3, 3), activation='relu', padding='same')(batch1)
...
conv3 = Conv2D(96, (3, 3), activation='relu', padding='same')(batch2)
conv4 = Conv2D(96, (3, 3), activation='relu', padding='same')(conv3)
max2 = MaxPooling2D(pool_size=(2, 2))(conv4)

batch3 = BatchNormalization()(max2)
conv5 = Conv2D(192, (3, 3), activation='relu', padding='same')(batch3)
conv6 = Conv2D(192, (3, 3), activation='relu', padding='same')(conv5)
max3 = MaxPooling2D(pool_size=(2, 2))(conv6)

batch4 = BatchNormalization()(max3)
conv7 = Conv2D(384, (3, 3), activation='relu', padding='same')(batch4)
conv8 = Conv2D(384, (3, 3), activation='relu', padding='same')(conv7)

globAv1 = GlobalAveragePooling2D()(max2)
globAv2 = GlobalAveragePooling2D()(max3)
