...
max4 = MaxPooling2D(pool_size=(2, 2))(conv8)

batch5 = BatchNormalization()(max4)
conv9 = Conv2D(512, (3, 3), activation='relu', padding='same')(batch5)
...
globAv3 = GlobalAveragePooling2D()(max4)
globAv4 = GlobalAveragePooling2D()(conv10)

conc = concatenate([globAv1, globAv2, globAv3, globAv4])
